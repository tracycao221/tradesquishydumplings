...
export const metadata: Metadata = {
  title: `How to Trade in ${siteConfig.gameName} (June 2026)`,
  description: `Learn how ${siteConfig.gameName} trading boards work, when to accept, when to ask for more, and what to check before confirming a dumpling trade.`,
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        ...
        title={`How to Trade in ${siteConfig.gameName}`}
        description="Trading happens on boards where both players place items and accept together. Check value, demand, and safety before you step on accept."
      />
      <section className="mt-10 content-card">
        <SectionHeader eyebrow="Steps" title="Trading board flow" />
      ...
      <section className="mt-8 grid gap-4 md:grid-cols-3">
        <Link className="content-card" href="/wiki/trading/value-list">Check values</Link>
        <Link className="content-card" href="/trading/fair-trade-calculator">Test a trade</Link>
